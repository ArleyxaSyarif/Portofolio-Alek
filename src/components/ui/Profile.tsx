...
const Profile = () => {
  return (
    <div
      className="h-screen w-full rounded-md relative flex items-center justify-center antialiased bg-black"
      id="beranda"
    >
      <div className="max-w-4xl mx-auto p-4 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex-1 text-center md:text-left mb-8 md:mb-0">
          ...
          <div className="flex gap-6 mt-8 justify-center md:justify-start">
            <button className="relative z-10 px-6 md:px-8 py-2 md:py-3 rounded-md text-sm md:text-base font-medium bg-gradient-to-r from-purple-500 to-blue-600 text-white hover:from-purple-300 hover:to-blue-700 transition-all duration-300 ease-in-out hover:scale-105">
              Sertifikasi
            </button>
            <button className="relative z-10 px-6 md:px-8 py-2 md:py-3 rounded-md text-sm md:text-base font-medium bg-transparent border-2 border-gray-400 text-white hover:border-purple-500 transition-all duration-300 ease-in-out hover:scale-105">
              Tentang Saya
            </button>
          </div>
        </div>
